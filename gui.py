...
"    }")
        ...
        self.gridLayout_9.addWidget(self.pushButton_send, 1, 2, 1, 1, QtCore.Qt.AlignRight)
...
"    }")
        ...
        self.gridLayout_9.addWidget(self.pushButton_send_cancel, 1, 3, 1, 1, QtCore.Qt.AlignRight)
