...
def file_to_db():
    ...
    if os.path.exists(var.base_dir+'/group_a.xlsx') == True and os.path.exists(var.base_dir+'/group_b.xlsx') == True \
        ...
        group_a = pd.read_excel(var.base_dir+'/group_a.xlsx', engine='openpyxl', sheet_name="group_a")
        group_b = pd.read_excel(var.base_dir+'/group_b.xlsx', engine='openpyxl', sheet_name="group_b")
        target = pd.read_excel(var.base_dir+'/target.xlsx', engine='openpyxl', sheet_name="target")
