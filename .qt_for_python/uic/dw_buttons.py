...
# Form implementation generated from reading ui file 'e:\Upwork\2020\gmail_app\gmail_app\env\Lib\site-packages\qdarkstyle\example\ui\dw_buttons.ui'
#
...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.toolButton_9 = QtWidgets.QToolButton(self.dockWidgetContents)
        ...
        self.toolButton_8 = QtWidgets.QToolButton(self.dockWidgetContents)
        self.toolButton_8.setEnabled(False)
        self.toolButton_8.setMinimumSize(QtCore.QSize(0, 0))
        self.toolButton_8.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.toolButton_8.setIcon(icon)
        self.toolButton_8.setToolButtonStyle(QtCore.Qt.ToolButtonTextOnly)
        self.toolButton_8.setObjectName("toolButton_8")
        self.gridLayout.addWidget(self.toolButton_8, 4, 5, 1, 1)
        self.toolButtonIcon_2 = QtWidgets.QToolButton(self.dockWidgetContents)
        self.toolButtonIcon_2.setEnabled(False)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/qss_icons/${ID}/rc/window_undock_focus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonIcon_2.setIcon(icon2)
        self.toolButtonIcon_2.setObjectName("toolButtonIcon_2")
        ...
        self.toolButtonChecked.setToolButtonStyle(QtCore.Qt.ToolButtonTextOnly)
        ...
        self.toolButton_10 = QtWidgets.QToolButton(self.dockWidgetContents)
        ...
        self.toolButtonChecked_2 = QtWidgets.QToolButton(self.dockWidgetContents)
        ...
        self.toolButtonChecked_2.setPopupMode(QtWidgets.QToolButton.DelayedPopup)
        self.toolButtonChecked_2.setToolButtonStyle(QtCore.Qt.ToolButtonTextOnly)
        self.toolButtonChecked_2.setObjectName("toolButtonChecked_2")
        self.gridLayout.addWidget(self.toolButtonChecked_2, 5, 5, 1, 1)
        self.toolButtonCheckedIcon_2 = QtWidgets.QToolButton(self.dockWidgetContents)
        ...
        self.toolButtonCheckedIcon_2.setObjectName("toolButtonCheckedIcon_2")
        ...
        self.toolButton_12 = QtWidgets.QToolButton(self.dockWidgetContents)
        self.toolButton_12.setEnabled(False)
        self.toolButton_12.setIcon(icon)
        self.toolButton_12.setToolButtonStyle(QtCore.Qt.ToolButtonFollowStyle)
        ...
        self.toolButton_7.setToolButtonStyle(QtCore.Qt.ToolButtonFollowStyle)
        self.toolButton_7.setObjectName("toolButton_7")
        self.gridLayout.addWidget(self.toolButton_7, 6, 5, 1, 1)
        self.toolButton_11 = QtWidgets.QToolButton(self.dockWidgetContents)
    ...
    def retranslateUi(self, DockWidget):
        ...
        self.label_33.setText(_translate("DockWidget", "ToolButton (Both/Text/Icon)"))
        self.toolButton_4.setText(_translate("DockWidget", "Tool"))
        ...
        self.toolButton_9.setText(_translate("DockWidget", "Tool"))
        self.toolButton_8.setToolTip(_translate("DockWidget", "This is a tool tip"))
        self.toolButton_8.setStatusTip(_translate("DockWidget", "This is a status tip"))
        self.toolButton_8.setWhatsThis(_translate("DockWidget", "This is \"what is this\""))
        self.toolButton_8.setText(_translate("DockWidget", "Tool"))
        self.toolButtonIcon_2.setText(_translate("DockWidget", "Icon"))
        self.label_2.setText(_translate("DockWidget", "<html><head/><body><p><span style=\" font-weight:600;\">ToolButton (Both/Text/Icon)</span></p></body></html>"))
        self.toolButton_5.setText(_translate("DockWidget", "Checked"))
        self.toolButtonChecked.setText(_translate("DockWidget", "Checked"))
        self.toolButtonCheckedIcon.setText(_translate("DockWidget", "Icon Checked"))
        self.toolButton_10.setText(_translate("DockWidget", "Checked"))
        self.toolButtonChecked_2.setText(_translate("DockWidget", "Checked"))
        self.toolButtonCheckedIcon_2.setText(_translate("DockWidget", "Icon Checked"))
        self.label_5.setText(_translate("DockWidget", "<html><head/><body><p><span style=\" font-weight:600;\">ToolButton (FollowStyle)</span></p></body></html>"))
        self.toolButton_6.setText(_translate("DockWidget", "Tool"))
        self.toolButton_2.setText(_translate("DockWidget", "Tool"))
        self.toolButton_3.setText(_translate("DockWidget", "..."))
        self.toolButton_12.setText(_translate("DockWidget", "Tool"))
        self.toolButton_7.setText(_translate("DockWidget", "Tool"))
        self.toolButton_11.setText(_translate("DockWidget", "..."))
        self.label_3.setText(_translate("DockWidget", "<html><head/><body><p><span style=\" font-weight:600;\">ToolButton (Arrows)</span></p></body></html>"))
        ...
        self.label_4.setText(_translate("DockWidget", "<html><head/><body><p><span style=\" font-weight:600;\">ToolButton (Menus)</span></p></body></html>"))
